...
package strucktobot_etl.csvtoexcel_0_1;
...
/**
 * Job: CSVtoExcel Purpose: Quick Test<br>
 * Description: Quick Test of CSV to Excel <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class CSVtoExcel implements TalendJob {
	...
	private final String jobName = "CSVtoExcel";
	private final String projectName = "STRUCKTOBOT_ETL";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CSVtoExcel.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_STRUCKTOBOT_ETL_CSVtoExcel = new byte[0];
    static byte[] commonByteArray_STRUCKTOBOT_ETL_CSVtoExcel = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRUCKTOBOT_ETL_CSVtoExcel) {
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("TWEET_ID="+String.valueOf(TWEET_ID));
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Users/user/Desktop/struckDBextgract-excel-2017-04-04.xls";
...
//create directory only if not exists		  
        ...
        writableSheet_tFileOutputExcel_1 = writeableWorkbook_tFileOutputExcel_1.getSheet("StruckTOExtract");
        if(writableSheet_tFileOutputExcel_1 == null){
        	writableSheet_tFileOutputExcel_1 = writeableWorkbook_tFileOutputExcel_1.createSheet("StruckTOExtract", writeableWorkbook_tFileOutputExcel_1.getNumberOfSheets());
		}
		...
		for(int i_tFileOutputExcel_1=0;i_tFileOutputExcel_1<4;i_tFileOutputExcel_1++){
			...
			if(fitCellViewSize_tFileOutputExcel_1%256!=0){
				fitWidth_tFileOutputExcel_1[i_tFileOutputExcel_1]+=1;
						...
						final jxl.write.WritableCellFormat cell_format_DATE_tFileOutputExcel_1=new jxl.write.WritableCellFormat(new jxl.write.DateFormat("yyyy-MM-dd"));		


		if (startRowNum_tFileOutputExcel_1 == 0){
	//modif end
		//modif start
			writableSheet_tFileOutputExcel_1.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "TWEET_ID"
			));
		//modif end
		fitWidth_tFileOutputExcel_1[0]=fitWidth_tFileOutputExcel_1[0]>8?fitWidth_tFileOutputExcel_1[0]:8;
		//modif start
			writableSheet_tFileOutputExcel_1.addCell(new jxl.write.Label(1, nb_line_tFileOutputExcel_1, "DATE"
			));
		//modif end
		fitWidth_tFileOutputExcel_1[1]=fitWidth_tFileOutputExcel_1[1]>4?fitWidth_tFileOutputExcel_1[1]:4;
		//modif start
			writableSheet_tFileOutputExcel_1.addCell(new jxl.write.Label(2, nb_line_tFileOutputExcel_1, "LAT"
			));
		//modif end
		fitWidth_tFileOutputExcel_1[2]=fitWidth_tFileOutputExcel_1[2]>3?fitWidth_tFileOutputExcel_1[2]:3;
		//modif start
			writableSheet_tFileOutputExcel_1.addCell(new jxl.write.Label(3, nb_line_tFileOutputExcel_1, "LNG"
			));
		//modif end
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Users/user/Desktop/struckDBExtract-2017-04-04.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.TWEET_ID = ParserUtils.parseTo_Long(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.DATE = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "yyyy-MM-dd");
...
//modif start
						...
						jxl.write.WritableCell cell_1_tFileOutputExcel_1 = new jxl.write.DateTime(columnIndex_tFileOutputExcel_1, startRowNum_tFileOutputExcel_1 + nb_line_tFileOutputExcel_1,
					
//modif end
								row1.DATE, cell_format_DATE_tFileOutputExcel_1
							);
//modif start					
							//If we keep the cell format from the existing cell in sheet
...
//modif ends							
							...
							currentWith_1_tFileOutputExcel_1=12;
...
//modif start
						...
						jxl.write.WritableCell cell_2_tFileOutputExcel_1 = new jxl.write.Number(columnIndex_tFileOutputExcel_1, startRowNum_tFileOutputExcel_1 + nb_line_tFileOutputExcel_1,
...
//modif ends							
							...
							int currentWith_2_tFileOutputExcel_1 = String.valueOf(((jxl.write.Number)cell_2_tFileOutputExcel_1).getValue()).trim().length();
							currentWith_2_tFileOutputExcel_1=currentWith_2_tFileOutputExcel_1>10?10:currentWith_2_tFileOutputExcel_1;
 ...
 */
    ...
    public static void main(String[] args){
        final CSVtoExcel CSVtoExcelClass = new CSVtoExcel();

        int exitCode = CSVtoExcelClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CSVtoExcel.class.getClassLoader().getResourceAsStream("strucktobot_etl/csvtoexcel_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CSVtoExcel");
        }
...
/************************************************************************************************
 *     47743 characters generated by Talend Open Studio for Data Integration 
 *     on the April 4, 2017 12:19:18 EDT PM
 ************************************************************************************************/